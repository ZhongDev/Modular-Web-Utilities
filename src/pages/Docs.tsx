      ...
      <div className="prose prose-lg max-w-none break-words">
        <section className="mb-12">
          ...
          <p className="text-gray-600 mb-6">
            This toolbox uses a modular architecture where each utility is a
            self-contained module. Follow these steps to create a new utility:
          </p>
        </section>
...
export default YourModule;`}</code>
        ...
        <section className="mb-12">
          ...
          <p className="text-gray-600 mb-4">
            Your module metadata must conform to the{" "}
  ...
  icon?: ReactElement | string; // Optional icon (emoji or React element)
            ...
            <div className="flex">
              <div className="ml-3">
                <p className="text-blue-700">
                  <strong>Automatic Discovery:</strong> The build pipeline
                  automatically discovers and registers any module that follows
                  the folder structure above. No manual registration required!
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="mb-12">
          ...
          <ul className="list-disc pl-6 text-gray-600 space-y-2">
            ...
            <li>
              Follow the existing design patterns (white cards, blue primary
              color)
            </li>
            <li>
              Ensure your module is responsive (works on mobile and desktop)
            </li>
        ...
        <section className="mb-12">
          ...
          <p className="text-gray-600">
            If you encounter any issues or have questions about creating
            modules, please refer to the existing modules in{" "}
            <code className="bg-gray-100 px-2 py-1 rounded">
              src/util-modules/
            </code>
            for reference implementations. You can also view the project
            repository on{" "}
            <a
              href="https://github.com/ZhongDev/Modular-Web-Utilities"
              target="_blank"
            ...
            for the latest code, issues, and contributions.
          </p>
        </section>
      </div>
    </div>
